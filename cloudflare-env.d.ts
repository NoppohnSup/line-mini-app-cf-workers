/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 8cdfaf58323725d5a548e680691e89da)
// Runtime types generated with workerd@1.20250816.0 2025-08-15 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_MINI_CHANNEL_ID: string;
		NEXT_PUBLIC_MINI_LIFF_ID: string;
		MINI_CHANNEL_SECRET: string;
		DB: D1Database;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_MINI_CHANNEL_ID" | "NEXT_PUBLIC_MINI_LIFF_ID" | "MINI_CHANNEL_SECRET">> {}
}
